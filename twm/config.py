...
CONFIGS['cartpole'] = {
    ...
    # environment
    'env_suite': 'd3rl',
    'env_frame_stack': None, #4,
    'env_grayscale': True,
    'env_num_channels': 4, # frame_stack * np.prod(observation_space.shape) TODO: Extend beyond cartpole
    'env_time_limit': 500,
    'env_reward_transform': 'tanh',
    'env_discount_factor': 0.99,
    'env_discount_lambda': 0.95,
    ...
    'dyn_num_heads': 16,
    'dyn_num_layers': 18,
    'dyn_feedforward_dim': 4096,
    'dyn_head_dim': 64,
    'dyn_z_dims': [512, 512],
    'dyn_reward_dims': [256, 256],
    'dyn_discount_dims': [256, 256],
    'dyn_input_rewards': True,
    'dyn_input_discounts': False,
    'dyn_act': 'silu',
    'dyn_norm': 'none',
